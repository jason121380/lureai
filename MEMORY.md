...
- **2026-09-01 帳號彈窗（左下角）**：語氣切換與本月用量移進「按名字打開」的彈窗，兩個分頁：設定（語氣）／用量（本月用量卡）。側欄不再常駐用量卡。點外面、Escape 都會關閉；打開時順手刷新用量。

- **2026-09-01 介面細修一批**：(1) 引用區加「知識來源：」標籤、編號籤縮小（25px 高、15px 圓號）；(2) 空白頁輸入框縮到 640px、全站輸入列拿掉陰影；(3) 「新對話」不重複疊空白對話——已有空的就切過去；(4) 刪除對話不用瀏覽器原生 confirm，改頁內兩段式（按一下變「確定刪除」，3 秒內再按才刪）。
